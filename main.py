...
def built_parser():
    ...
    if task == 'left':
        parser.add_argument('--load_dir', type=str, default='./utils/models/{}/experiment-2021-09-27-14-33-44'.format(task))
        parser.add_argument('--load_ite', type=str, default=490000)
    elif task == 'right':
