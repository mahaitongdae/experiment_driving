...
class AttnPolicy4Lagrange(tf.Module):
    ...
    def __init__(self, args):
        ...
        # self.value = policy_model_cls(37, n_hiddens, n_units, hidden_activation, 1, name='value',
        #                                output_activation='linear') # todo: modified from 0610
    ...
    #         value = self.tf.squeeze(self.value(obs[:, :37]), axis=1)
    #     return value
